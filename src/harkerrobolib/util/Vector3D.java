...
public class Vector3D {
    /**
     * The X-position of the point. This represents movement along the axis from one alliance side of the field towards
     * the other alliance side of the field.
     */
    private double X;
    ...
    /**
     * The Y-position of the point. This represents movement along the axis from the sides of the field, parallel to the
     * alliance walls and game objectives.
     */
    private double Y;
    ...
    /**
     * The Z-position of the point. This represents movement up and down in the direction of gravity by the Earth. Zero
     * represents a ground-level object, while an increasing value would represent moving up.
     */
    private double Z;
    ...
    public Vector3D cross (Vector3D v) {
        /*
         * a cross b formula: X = a2b3 - a3b2 Y = a3b1 - a1b3 Z = a1b2 - a2b1
         */
