...
public class HSSwerveDriveOdometry extends CommandBase {
    ...
    public HSSwerveDriveOdometry(Trajectory trajectory, Rotation2d heading, HSSwerveDrivetrain drivetrain, 
            Supplier<Pose2d> pose, SwerveDriveKinematics kinematics, PIDController xController, PIDController yController,
    ...
    public void execute() {
        ...
        double targetAngularVel = m_thetaController.calculate(Math.toRadians(-drivetrain.getPigeon().getFusedHeading()),
                heading.getRadians());
